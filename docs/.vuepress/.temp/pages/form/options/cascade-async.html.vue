<template><h2 id="级联异步数据" tabindex="-1"><a class="header-anchor" href="#级联异步数据" aria-hidden="true">#</a> 级联异步数据</h2>
<div class="custom-container tip"><p class="custom-container-title">提示</p>
<p>curdform实例提供<code>loadOptions</code>函数，用来重新调用某个formItem的<code>asyncOptions</code>异步函数。要求<code>asyncOptions</code>必须配置，否则会出错。</p>
</div>
